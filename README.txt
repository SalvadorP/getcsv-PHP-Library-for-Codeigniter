...
This is a simple PHP library built by Jason Michels (http://www.thebizztech.com), that can be used in Codeigniter to read in CSV files and return them as an associated array.
